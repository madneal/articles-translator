...
CORS 工作的方式是：
 ...
 3. 浏览器将会使用 *Origin*, *Access-Control-Request-Method *and *Access-Control-Request* 头向 [test2.domain.com](http://test2.domain.com/) 发送一个 OPTIONS 请求。

 4. [test2.domain.com](http://test2.domain.com/) 必须现在响应合适的 *Access-Control headers*。
